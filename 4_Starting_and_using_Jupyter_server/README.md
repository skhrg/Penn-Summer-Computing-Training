A Jupyter notebook is a useful way of working with python (as well as a few other languages).  We will show you what makes it differnt than a standaline python script, or an ipython session.
